Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/21e1e289da0f36e45b026c146c0a3c5a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				#endif
				float4 rotation = float4(float4(0,0,0,1).xyz + float3(180, 0, 0) + float4(300,0,0,1) * _Time.x + ALrotation + CTALRotation, float4(0,0,0,1).w);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalScale = float4(1.241287,0.7669151,0,0);
				Decal0.m_DecalSideOffset = float4(0,0,0,0);
				Decal0.m_DecalPosition = float4(0.5144415,0.3987622,0,0);
				Decal0.m_DecalRotationSpeed = (0.0 /*_DecalRotationSpeed*/);
				Decal0.m_DecalEmissionStrength = (0.3 /*_DecalEmissionStrength*/);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (1.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionStrength0 *= calculateBlinkingEmission((0.5 /*_EmissiveBlink_Min*/), (1.0 /*_EmissiveBlink_Max*/), (2.0 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
			...
			{
				float2 st = frac(poiMesh.uv[(4.0 /*_GlitterUV*/)] + float4(0.15,-0.35,0,0).xy * _Time.x) * (200.0 /*_GlitterFrequency*/);
				...
				half3 glitterColor = poiThemeColor(poiMods, float4(1,1,0,1), (0.0 /*_GlitterColorThemeIndex*/));
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.8 /*_GlitterBias*/)), poiCam.viewDir)), (113.0 /*_GlitterContrast*/)), 0);
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (113.0 /*_GlitterContrast*/)), 0);
